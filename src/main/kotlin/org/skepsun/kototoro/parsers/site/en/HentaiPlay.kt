...
@ContentSourceParser("HENTAIPLAY", "HentaiPlay", "en", type = ContentType.HENTAI_VIDEO)
internal class HentaiPlay(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.HENTAIPLAY, pageSize = 24) {

    override val configKeyDomain = ConfigKey.Domain("hentaiplay.net")
