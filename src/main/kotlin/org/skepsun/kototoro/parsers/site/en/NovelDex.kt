...
@ContentSourceParser("NOVELDEX", "NovelDex", "en", type = ContentType.NOVEL)
internal class NovelDex(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.NOVELDEX, pageSize = 50) {

    override val configKeyDomain = ConfigKey.Domain("noveldex.io")
