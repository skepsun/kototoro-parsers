...
@ContentSourceParser("HENTAIFOXTV", "HentaiFox.tv", "en", type = ContentType.HENTAI_VIDEO)
internal class HentaiFoxTV(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.HENTAIFOXTV, pageSize = 24) {

    override val configKeyDomain = ConfigKey.Domain("hentaifox.tv")
    ...
    private fun parseList(doc: Document): List<Content> {
        ...
        for (link in doc.select("a[href*=/video/], .a_item a[href], .v_item a[href]")) {
            ...
            val container = link.parents().firstOrNull { p ->
                p.hasClass("a_item") || p.hasClass("v_item") || p.hasClass("card")
            } ?: link.parent()!!
    ...
    private companion object {
        val HENTAI_GENRES = setOf(
            ContentTag("Ahegao", "ahegao", ContentParserSource.HENTAIFOXTV),
            ContentTag("Anal", "anal", ContentParserSource.HENTAIFOXTV),
            ContentTag("Big Boobs", "big-boobs", ContentParserSource.HENTAIFOXTV),
            ContentTag("Blowjob", "blowjob", ContentParserSource.HENTAIFOXTV),
            ContentTag("Bondage", "bondage", ContentParserSource.HENTAIFOXTV),
            ContentTag("Creampie", "creampie", ContentParserSource.HENTAIFOXTV),
            ContentTag("Futanari", "futanari", ContentParserSource.HENTAIFOXTV),
            ContentTag("Gangbang", "gangbang", ContentParserSource.HENTAIFOXTV),
            ContentTag("Harem", "harem", ContentParserSource.HENTAIFOXTV),
            ContentTag("Incest", "incest", ContentParserSource.HENTAIFOXTV),
            ContentTag("Loli", "loli", ContentParserSource.HENTAIFOXTV),
            ContentTag("Maid", "maid", ContentParserSource.HENTAIFOXTV),
            ContentTag("Masturbation", "masturbation", ContentParserSource.HENTAIFOXTV),
            ContentTag("MILF", "milf", ContentParserSource.HENTAIFOXTV),
            ContentTag("NTR", "ntr", ContentParserSource.HENTAIFOXTV),
            ContentTag("Rape", "rape", ContentParserSource.HENTAIFOXTV),
            ContentTag("Schoolgirl", "schoolgirl", ContentParserSource.HENTAIFOXTV),
            ContentTag("Succubus", "succubus", ContentParserSource.HENTAIFOXTV),
            ContentTag("Tentacles", "tentacles", ContentParserSource.HENTAIFOXTV),
            ContentTag("Threesome", "threesome", ContentParserSource.HENTAIFOXTV),
            ContentTag("Yaoi", "yaoi", ContentParserSource.HENTAIFOXTV),
            ContentTag("Yuri", "yuri", ContentParserSource.HENTAIFOXTV),
            ContentTag("Monster", "monster", ContentParserSource.HENTAIFOXTV),
            ContentTag("Femdom", "femdom", ContentParserSource.HENTAIFOXTV),
        )
    }
}
