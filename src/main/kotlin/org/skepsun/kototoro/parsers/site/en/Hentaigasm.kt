...
@ContentSourceParser("HENTAIGASM", "Hentaigasm", "en", type = ContentType.HENTAI_VIDEO)
internal class Hentaigasm(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.HENTAIGASM, pageSize = 24) {

    override val configKeyDomain = ConfigKey.Domain("hentaigasm.com")
    ...
    private fun parseList(doc: Document): List<Content> {
        ...
        for (link in doc.select("a[href*=/hentai/]")) {
            ...
            val container = link.parents().firstOrNull { p ->
                p.hasClass("hentai-item") || p.hasClass("card") || p.hasClass("thumb")
            } ?: link.parent()!!!!
    ...
    private fun buildListUrl(page: Int, filter: ContentListFilter): String {
        ...
        return if (!filter.query.isNullOrBlank()) {
            ...
            "https://$domain/hentai?genre=$tagParam&page=$page"
        }
    }

    private companion object {
        val HENTAI_GENRES = setOf(
            ContentTag("Ahegao", "ahegao", ContentParserSource.HENTAIGASM),
            ContentTag("Anal", "anal", ContentParserSource.HENTAIGASM),
            ContentTag("Big Boobs", "big-boobs", ContentParserSource.HENTAIGASM),
            ContentTag("Blowjob", "blowjob", ContentParserSource.HENTAIGASM),
            ContentTag("Bondage", "bondage", ContentParserSource.HENTAIGASM),
            ContentTag("Creampie", "creampie", ContentParserSource.HENTAIGASM),
            ContentTag("Futanari", "futanari", ContentParserSource.HENTAIGASM),
            ContentTag("Gangbang", "gangbang", ContentParserSource.HENTAIGASM),
            ContentTag("Harem", "harem", ContentParserSource.HENTAIGASM),
            ContentTag("Incest", "incest", ContentParserSource.HENTAIGASM),
            ContentTag("Loli", "loli", ContentParserSource.HENTAIGASM),
            ContentTag("Maid", "maid", ContentParserSource.HENTAIGASM),
            ContentTag("Masturbation", "masturbation", ContentParserSource.HENTAIGASM),
            ContentTag("MILF", "milf", ContentParserSource.HENTAIGASM),
            ContentTag("NTR", "ntr", ContentParserSource.HENTAIGASM),
            ContentTag("Rape", "rape", ContentParserSource.HENTAIGASM),
            ContentTag("Schoolgirl", "schoolgirl", ContentParserSource.HENTAIGASM),
            ContentTag("Succubus", "succubus", ContentParserSource.HENTAIGASM),
            ContentTag("Tentacles", "tentacles", ContentParserSource.HENTAIGASM),
            ContentTag("Threesome", "threesome", ContentParserSource.HENTAIGASM),
            ContentTag("Yaoi", "yaoi", ContentParserSource.HENTAIGASM),
            ContentTag("Yuri", "yuri", ContentParserSource.HENTAIGASM),
            ContentTag("Monster", "monster", ContentParserSource.HENTAIGASM),
            ContentTag("Femdom", "femdom", ContentParserSource.HENTAIGASM),
        )
    }
}
