...
@ContentSourceParser("NOVELBUDDY", "NovelBuddy", "en", type = ContentType.NOVEL)
internal class NovelBuddy(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.NOVELBUDDY, pageSize = 50) {

    override val configKeyDomain = ConfigKey.Domain("novelbuddy.com")
