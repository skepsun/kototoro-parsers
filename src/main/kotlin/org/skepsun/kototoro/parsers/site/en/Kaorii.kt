...
@ContentSourceParser("KAORII", "Kaorii", "en", type = ContentType.VIDEO)
internal class Kaorii(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.KAORII, pageSize = 24) {

    override val configKeyDomain = ConfigKey.Domain("kaorii.app")
