...
@ContentSourceParser("LIGHTNOVELWORLD", "LightNovelWorld", "en", type = ContentType.NOVEL)
internal class LightNovelWorld(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.LIGHTNOVELWORLD, pageSize = 50) {

    override val configKeyDomain = ConfigKey.Domain("lightnovelworld.org")
