...
@ContentSourceParser("MIRURO", "Miruro", "en", type = ContentType.VIDEO)
internal class Miruro(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.MIRURO, pageSize = 24) {

    override val configKeyDomain = ConfigKey.Domain("www.miruro.to")
    ...
    override suspend fun getDetails(manga: Content): Content {
        ...
        val title = doc.selectFirst("meta[property=og:title]")?.attr("content")?.removeSuffix(" - Miruro")?.trim()
            ?: manga.title
