...
@ContentSourceParser("ANIMOTVSLASH", "Animotvslash", "en", type = ContentType.VIDEO)
internal class Animotvslash(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.ANIMOTVSLASH, pageSize = 24) {

    override val configKeyDomain = ConfigKey.Domain("animotvslash.org")
    ...
    override suspend fun getListPage(page: Int, order: SortOrder, filter: ContentListFilter): List<Content> {
        ...
        val url = if (q.isNotEmpty()) "https://$domain/?s=$q"
