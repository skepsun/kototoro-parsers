...
@ContentSourceParser("ZANORA", "Zanora", "en", type = ContentType.VIDEO)
internal class Zanora(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.ZANORA, pageSize = 30) {

    override val configKeyDomain = ConfigKey.Domain("zanora.lol")
