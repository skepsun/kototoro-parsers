...
internal class AnimeHeaven(context: ContentLoaderContext) :
    ...
    override suspend fun getListPage(page: Int, order: SortOrder, filter: ContentListFilter): List<Content> {
        ...
        val url = if (q.isNotEmpty()) "https://$domain/search.php?q=$q"
    ...
    override suspend fun getDetails(manga: Content): Content {
        ...
        val chapterLinks = doc.select("a[href*=/episode/], a[href*=/watch/], a[href*=/anime/]")
    ...
    private fun parseList(doc: Document): List<Content> {
        ...
        for (link in doc.select("a[href*=/anime.php], a[href*=/anime/]")) {
