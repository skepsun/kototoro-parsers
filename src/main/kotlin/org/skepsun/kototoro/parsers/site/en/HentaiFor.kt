...
@ContentSourceParser("HENTAIFOR", "HentaiFor", "en", type = ContentType.HENTAI_VIDEO)
internal class HentaiFor(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.HENTAIFOR, pageSize = 24) {

    override val configKeyDomain = ConfigKey.Domain("hentai-for.net")
