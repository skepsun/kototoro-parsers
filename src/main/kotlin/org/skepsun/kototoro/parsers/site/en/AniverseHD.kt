...
@ContentSourceParser("ANIVERSEHD", "AniverseHD", "en", type = ContentType.VIDEO)
internal class AniverseHD(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.ANIVERSEHD, pageSize = 24) {

    override val configKeyDomain = ConfigKey.Domain("aniversehd.com")
    ...
    private companion object {
        val GENRES = setOf(
            ContentTag("Action", "action", ContentParserSource.ANIVERSEHD),
            ContentTag("Adventure", "adventure", ContentParserSource.ANIVERSEHD),
            ContentTag("Comedy", "comedy", ContentParserSource.ANIVERSEHD),
            ContentTag("Drama", "drama", ContentParserSource.ANIVERSEHD),
            ContentTag("Fantasy", "fantasy", ContentParserSource.ANIVERSEHD),
            ContentTag("Horror", "horror", ContentParserSource.ANIVERSEHD),
            ContentTag("Mecha", "mecha", ContentParserSource.ANIVERSEHD),
            ContentTag("Music", "music", ContentParserSource.ANIVERSEHD),
            ContentTag("Mystery", "mystery", ContentParserSource.ANIVERSEHD),
            ContentTag("Romance", "romance", ContentParserSource.ANIVERSEHD),
            ContentTag("Sci-Fi", "sci-fi", ContentParserSource.ANIVERSEHD),
            ContentTag("Slice of Life", "slice-of-life", ContentParserSource.ANIVERSEHD),
            ContentTag("Sports", "sports", ContentParserSource.ANIVERSEHD),
            ContentTag("Supernatural", "supernatural", ContentParserSource.ANIVERSEHD),
            ContentTag("Thriller", "thriller", ContentParserSource.ANIVERSEHD),
            ContentTag("Shounen", "shounen", ContentParserSource.ANIVERSEHD),
            ContentTag("Seinen", "seinen", ContentParserSource.ANIVERSEHD),
            ContentTag("Ecchi", "ecchi", ContentParserSource.ANIVERSEHD),
            ContentTag("Isekai", "isekai", ContentParserSource.ANIVERSEHD),
            ContentTag("Magic", "magic", ContentParserSource.ANIVERSEHD),
            ContentTag("Martial Arts", "martial-arts", ContentParserSource.ANIVERSEHD),
            ContentTag("School", "school", ContentParserSource.ANIVERSEHD),
            ContentTag("Super Power", "super-power", ContentParserSource.ANIVERSEHD),
            ContentTag("Game", "game", ContentParserSource.ANIVERSEHD),
            ContentTag("Historical", "historical", ContentParserSource.ANIVERSEHD),
        )
    }
}
