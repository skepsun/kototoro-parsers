...
@ContentSourceParser("MYHENTAIMOVIE", "MyHentaiMovie", "en", type = ContentType.HENTAI_VIDEO)
internal class MyHentaiMovie(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.MYHENTAIMOVIE, pageSize = 24) {

    override val configKeyDomain = ConfigKey.Domain("myhentaimovie.com")
    ...
    override suspend fun getDetails(manga: Content): Content {
        ...
        val title = doc.selectFirst("meta[property=og:title]")?.attr("content")
            ?.removeSuffix(" - MyHentaiMovie")?.trim()
