...
@ContentSourceParser("ANIZONE", "AniZone", "en", type = ContentType.VIDEO)
internal class AniZone(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.ANIZONE, pageSize = 24) {

    override val configKeyDomain = ConfigKey.Domain("anizone.to")
