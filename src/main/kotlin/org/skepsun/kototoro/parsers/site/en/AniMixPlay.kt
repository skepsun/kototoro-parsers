...
@ContentSourceParser("ANIMIXPLAY", "AniMixPlay", "en", type = ContentType.VIDEO)
internal class AniMixPlay(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.ANIMIXPLAY, pageSize = 24) {

    override val configKeyDomain = ConfigKey.Domain("animixplay.fun")
    ...
    override suspend fun getListPage(page: Int, order: SortOrder, filter: ContentListFilter): List<Content> {
        ...
        val url = if (q.isNotEmpty()) "https://$domain/search.html?keyword=$q&page=$page"
        else "https://$domain/anime-list.html?page=$page"
