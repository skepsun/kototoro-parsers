...
@ContentSourceParser("HENTAIMOON", "HentaiMoon", "en", type = ContentType.HENTAI_VIDEO)
internal class HentaiMoon(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.HENTAIMOON, pageSize = 24) {

    override val configKeyDomain = ConfigKey.Domain("hentai-moon.com")
