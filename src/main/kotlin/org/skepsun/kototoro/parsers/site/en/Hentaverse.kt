...
@ContentSourceParser("HENTAVERSE", "Hentaverse", "en", type = ContentType.HENTAI_VIDEO)
internal class Hentaverse(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.HENTAVERSE, pageSize = 24) {

    override val configKeyDomain = ConfigKey.Domain("hentaverse.com")
