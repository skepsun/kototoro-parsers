...
@ContentSourceParser("XANIMEPORN", "Xanimeporn", "en", type = ContentType.HENTAI_VIDEO)
internal class Xanimeporn(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.XANIMEPORN, pageSize = 24) {

    override val configKeyDomain = ConfigKey.Domain("www.xanimeporn.com")
