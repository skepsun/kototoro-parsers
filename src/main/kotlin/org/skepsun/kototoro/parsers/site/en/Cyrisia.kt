...
@ContentSourceParser("CYRISIA", "Cyrisia", "en", type = ContentType.NOVEL)
internal class Cyrisia(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.valueOf("CYRISIA"), pageSize = 50) {

    override val configKeyDomain = ConfigKey.Domain("cyrisia.com")
    ...
    private fun parseList(doc: Document): List<Content> {
        ...
        for (el in doc.select(".novel-card, .list-item, .novel-entry, article")) {
