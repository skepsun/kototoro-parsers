...
@ContentSourceParser("WUXIAWORLDSITE", "WuxiaWorldSite", "en", type = ContentType.NOVEL)
internal class WuxiaWorldSite(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.valueOf("WUXIAWORLDSITE"), pageSize = 50) {

    override val configKeyDomain = ConfigKey.Domain("wuxiaworld.site")
