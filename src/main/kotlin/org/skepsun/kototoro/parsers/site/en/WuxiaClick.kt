...
@ContentSourceParser("WUXIACLICK", "WuxiaClick", "en", type = ContentType.NOVEL)
internal class WuxiaClick(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.WUXIACLICK, pageSize = 50) {

    override val configKeyDomain = ConfigKey.Domain("wuxia.click")
