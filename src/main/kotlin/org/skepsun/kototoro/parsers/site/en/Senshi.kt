...
@ContentSourceParser("SENSHI", "Senshi", "en", type = ContentType.VIDEO)
internal class Senshi(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.SENSHI, pageSize = 24) {

    override val configKeyDomain = ConfigKey.Domain("senshi.live")
