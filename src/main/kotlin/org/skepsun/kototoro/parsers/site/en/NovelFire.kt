...
@ContentSourceParser("NOVELFIRE", "NovelFire", "en", type = ContentType.NOVEL)
internal class NovelFire(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.NOVELFIRE, pageSize = 50) {

    override val configKeyDomain = ConfigKey.Domain("novelfire.net")
