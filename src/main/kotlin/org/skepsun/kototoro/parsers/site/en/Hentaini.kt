...
@ContentSourceParser("HENTAINI", "Hentaini", "en", type = ContentType.HENTAI_VIDEO)
internal class Hentaini(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.HENTAINI, pageSize = 24) {

    override val configKeyDomain = ConfigKey.Domain("hentaini.com")
    ...
    private companion object {
        val HENTAI_GENRES = setOf(
            ContentTag("Ahegao", "ahegao", ContentParserSource.HENTAINI),
            ContentTag("Anal", "anal", ContentParserSource.HENTAINI),
            ContentTag("Big Boobs", "big-boobs", ContentParserSource.HENTAINI),
            ContentTag("Blowjob", "blowjob", ContentParserSource.HENTAINI),
            ContentTag("Bondage", "bondage", ContentParserSource.HENTAINI),
            ContentTag("Creampie", "creampie", ContentParserSource.HENTAINI),
            ContentTag("Futanari", "futanari", ContentParserSource.HENTAINI),
            ContentTag("Gangbang", "gangbang", ContentParserSource.HENTAINI),
            ContentTag("Harem", "harem", ContentParserSource.HENTAINI),
            ContentTag("Incest", "incest", ContentParserSource.HENTAINI),
            ContentTag("Loli", "loli", ContentParserSource.HENTAINI),
            ContentTag("Maid", "maid", ContentParserSource.HENTAINI),
            ContentTag("Masturbation", "masturbation", ContentParserSource.HENTAINI),
            ContentTag("MILF", "milf", ContentParserSource.HENTAINI),
            ContentTag("NTR", "ntr", ContentParserSource.HENTAINI),
            ContentTag("Rape", "rape", ContentParserSource.HENTAINI),
            ContentTag("Schoolgirl", "schoolgirl", ContentParserSource.HENTAINI),
            ContentTag("Succubus", "succubus", ContentParserSource.HENTAINI),
            ContentTag("Tentacles", "tentacles", ContentParserSource.HENTAINI),
            ContentTag("Threesome", "threesome", ContentParserSource.HENTAINI),
            ContentTag("Yaoi", "yaoi", ContentParserSource.HENTAINI),
            ContentTag("Yuri", "yuri", ContentParserSource.HENTAINI),
            ContentTag("Monster", "monster", ContentParserSource.HENTAINI),
            ContentTag("Femdom", "femdom", ContentParserSource.HENTAINI),
        )
    }
}
