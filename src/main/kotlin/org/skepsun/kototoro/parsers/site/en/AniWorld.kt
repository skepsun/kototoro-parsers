...
internal class AniWorld(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.ANIWORLD, pageSize = 24) {
    ...
    override suspend fun getDetails(manga: Content): Content {
        ...
        val episodeLinks = doc.select("a[href*=/anime/stream/]")
    ...
    private fun parseList(doc: Document): List<Content> {
        ...
        val cards = doc.select("a[href*=/anime/stream/]").filter { el ->
