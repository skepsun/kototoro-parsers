...
@ContentSourceParser("ARMAELLLIBRARY", "ArmaellLibrary", "en", type = ContentType.NOVEL)
internal class ArmaellLibrary(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.valueOf("ARMAELLLIBRARY"), pageSize = 50) {

    override val configKeyDomain = ConfigKey.Domain("armaell-library.net")
    ...
    private fun buildListUrl(page: Int, order: SortOrder, filter: ContentListFilter): String {
        ...
        return "https://$domain/library?sort=$sort&page=$page$tagParam"
    }
