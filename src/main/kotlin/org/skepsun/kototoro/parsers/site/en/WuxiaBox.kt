...
@ContentSourceParser("WUXIABOX", "WuxiaBox", "en", type = ContentType.NOVEL)
internal class WuxiaBox(context: ContentLoaderContext) :
    PagedContentParser(context, ContentParserSource.WUXIABOX, pageSize = 50) {

    override val configKeyDomain = ConfigKey.Domain("wuxiabox.com")
